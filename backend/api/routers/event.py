...
@router.get("/events/{polorId}", response_model=List[schema.Event])
...
@router.post("/events", response_model=schema.EventCreateResponse)
...
@router.put("/events/{id}", response_model=schema.EventCreateResponse)
