...
@router.get("/enrichments/{polorId}", response_model=List[schema.Enrichment])
async def get_enrichments(polorId: int, date: str = Query(...), db: AsyncSession = Depends(get_db)):
