...
@router.get("/api/polorCageLog", response_model=List[schema.PolorCageLog])
...
@router.post("/api/polorCageLog", response_model=schema.PolorCageLogCreateResponse)
...
@router.put("/api/polorCageLog/{id}", response_model=schema.PolorCageLogCreateResponse)
